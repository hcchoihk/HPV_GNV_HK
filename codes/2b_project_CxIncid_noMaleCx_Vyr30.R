...
output_folder_proj_CxInc_new = gsub("(/){2,}","/", paste(output_folder_proj_CxInc, "noMaleCx_Vyr30", "/", sep="/"));
dir.create(output_folder_proj_CxInc_new, showWarnings = FALSE)


# Load pre-saved data
fname_loaddata = paste0(folder_main, "data/HPVmodel_nonCeCx_project_data_noMaleCx_Vyr30.RData");
load( fname_loaddata )
